...
-- Started on 2013-10-17 10:48:44
...
COMMENT ON DATABASE pindorama IS 'yolo-octo-lama project database';
...
ALTER TABLE pdr_contas OWNER TO postgres;
...
ALTER TABLE pdr_contas_conta_id_seq OWNER TO postgres;
...
ALTER TABLE pdr_movimentacoes OWNER TO postgres;
...
ALTER TABLE pdr_movimentacoes_movimentacao_id_seq OWNER TO postgres;
...
INSERT INTO pdr_movimentacoes VALUES (1, '2013-08-08 16:20:01-03', 1, 1300.00, 'depósito');
INSERT INTO pdr_movimentacoes VALUES (2, '2013-08-15 10:10:10-03', 2, 120.99, 'depósito');
INSERT INTO pdr_movimentacoes VALUES (3, '2013-01-01 00:00:00-02', 3, 1.99, 'depósito');
INSERT INTO pdr_movimentacoes VALUES (4, '2013-08-08 09:40:20.838-03', 1, 12900.12, 'depósito');
...
-- Completed on 2013-10-17 10:48:44
